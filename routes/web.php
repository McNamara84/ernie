...
// CSRF cookie endpoint – replaces Laravel Sanctum's /sanctum/csrf-cookie.
// The VerifyCsrfToken middleware automatically sets the XSRF-TOKEN cookie
// on every response, so this endpoint only needs to return 204 No Content.
