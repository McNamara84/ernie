...
entity "resource_listing_projections" as resource_listing_projections {
    ...
    * search_text : TEXT
    ...
    party_name_search_text : TEXT <<nullable>>
    created_at : TIMESTAMP
    updated_at : TIMESTAMP
}
...
entity "landing_page_links" as landing_page_links {
    * **id** : BIGINT <<PK>>
    --
    * landing_page_id : BIGINT <<FK>>
    * url : VARCHAR(2048)
...
entity "suggested_orcids" as suggested_orcids {
    * **id** : BIGINT <<PK>>
    --
    * resource_id : BIGINT <<FK>>
    * person_id : BIGINT <<FK>>
    * suggested_orcid : VARCHAR(19)
    * similarity_score : DECIMAL(5,4)
    candidate_first_name : VARCHAR(255)
    candidate_last_name : VARCHAR(255)
    candidate_affiliations : JSON
...
entity "dismissed_orcids" as dismissed_orcids {
    * **id** : BIGINT <<PK>>
    --
    * person_id : BIGINT <<FK>>
    * orcid : VARCHAR(19)
