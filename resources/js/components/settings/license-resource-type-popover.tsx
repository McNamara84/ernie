        ...
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent className="w-72 p-0" align="start">
                <div className="border-b p-3">
                    ...
                    <p className="text-xs text-muted-foreground">Uncheck resource types where this license should NOT be available.</p>
                </div>
                ...
                <div className="border-t p-2">
                    <div className="flex justify-between text-xs text-muted-foreground">
                        ...
                        {excludedCount > 0 && (
                            <Button variant="ghost" size="sm" className="h-auto p-0 text-xs" onClick={() => onExcludedChange([])}>
                                Reset
                            </Button>
                        )}
                    </div>
