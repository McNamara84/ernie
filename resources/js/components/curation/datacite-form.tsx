        ...
        if (combined.length > 0) {
            return combined
                ...
                .map((kw) => ({
                    ...
                    classificationCode: 'classificationCode' in kw && typeof kw.classificationCode === 'string' && kw.classificationCode.trim() !== '' ? kw.classificationCode : undefined,
    ...
    const buildPayload = useCallback(() => {
        ...
        const payload: {
            ...
            gcmdKeywords: gcmdKeywords.map((kw) => ({
                ...
                ...(kw.classificationCode ? { classificationCode: kw.classificationCode } : {}),
