...
export function OrcidIcon({ className }: PidIconProps) {
    return (
        <svg data-slot="orcid-icon" className={cn('h-4 w-4', className)} viewBox="0 0 256 256" aria-hidden="true">
...
export function RorIcon({ className }: PidIconProps) {
    return (
        <svg data-slot="ror-icon" className={cn('h-4 w-4', className)} viewBox="0 0 74 74" aria-hidden="true">
            <g fill="none">
                <path d="M37 74c20.435 0 37-16.565 37-37S57.435 0 37 0 0 16.565 0 37s16.565 37 37 37z" fill="#53BAA1" />
                <path
...
export function CrossrefFunderIcon({ className }: PidIconProps) {
    return (
        <svg data-slot="crossref-funder-icon" className={cn('h-4 w-4', className)} viewBox="0 0 100 100" aria-hidden="true">
            <rect width="100" height="100" rx="12" fill="#FFC107" />
            <text x="50" y="68" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="52" fontWeight="bold" fill="#fff">
                C
            </text>
        </svg>
    );
