...
export { CENTRAL_RADIUS, CONTRIBUTOR_COLOR, CONTRIBUTOR_RADIUS,CREATOR_COLOR, CREATOR_RADIUS, EDGE_FALLBACK_COLOR, GFZ_BLUE, INSTITUTION_COLOR, INSTITUTION_RADIUS, NODE_FALLBACK_COLOR, NODE_RADIUS };
