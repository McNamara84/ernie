                ...
                content: (
                    <>
                        ...
                        <ul className="list-inside list-disc space-y-1">
                            ...
                            <li>
                                <strong>Persistent Identifiers:</strong> Manage PID registries like PID4INST (b2inst) for linking research instruments
                                and ROR for research organizations
                            </li>
                            <li>
            ...
            },
            {
                ...
                content: (
                    <>
                        ...
                        <p>
                            Click <strong>Export Selected</strong> to download a single ZIP archive containing the metadata of every selected resource
                        ...
                        <p>
                            Click <strong>Register Selected</strong> to push every selected resource to DataCite in one batch. The bulk flow{' '}
                            <strong>only updates resources that already have a DOI</strong>; the button is disabled when the selection contains any
