...
![Version](https://img.shields.io/badge/version-1.0.0rc2-blue)
...
**🎉 Second Release Candidate (v1.0.0rc2)** – This is the second release candidate of ERNIE, featuring complete core metadata curation functionality, DOI registration workflows, and comprehensive testing. See the [interactive changelog](/changelog) for full release notes.
