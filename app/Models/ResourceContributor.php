 ...
 * @property-read Collection<int, ContributorType> $contributorTypes
 * @property-read Collection<int, Affiliation> $affiliations
 *
 * @see https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/contributor/
 */
#[Fillable(['resource_id', 'contributorable_type', 'contributorable_id', 'position', 'email', 'website'])]
