 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, RelatedItemCreatorAffiliation> $affiliations
 */
#[Fillable([
    'related_item_id',
    'name_type',
...
class RelatedItemCreator extends Model
{
    ...
    /** @return HasMany<RelatedItemCreatorAffiliation, $this> */
    public function affiliations(): HasMany
    {
        return $this->hasMany(RelatedItemCreatorAffiliation::class)->orderBy('position');
    }
}
