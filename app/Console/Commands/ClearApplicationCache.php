...
#[Signature('cache:clear-app
                            {category? : Cache category to clear (resources, vocabularies, ror, orcid, doi, system, assistance, portal, all)}')]
class ClearApplicationCache extends Command
{
    ...
    public function handle(): int
    {
        ...
        $validCategories = ['resources', 'vocabularies', 'ror', 'orcid', 'doi', 'system', 'assistance', 'portal', 'all'];
