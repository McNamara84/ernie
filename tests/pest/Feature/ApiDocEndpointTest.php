...
it('returns the OpenAPI documentation as JSON', function () {
    getJson('/api/v1/doc')
        ...
        ->assertJsonPath('paths./api/v1/roles/authors/ernie.get.description', 'Returns all author roles that are active for Ernie.')
        ...
        ->assertJsonPath('paths./api/v1/roles/contributor-persons/ernie.get.description', 'Returns all contributor person roles that are active for Ernie.')
        ...
        ->assertJsonPath('paths./api/v1/roles/contributor-institutions/ernie.get.description', 'Returns all contributor institution roles that are active for Ernie.')
        ...
        ->assertJsonMissingPath('paths./api/v1/roles/authors/ernie.get.security')
        ->assertJsonMissingPath('paths./api/v1/roles/contributor-persons/ernie.get.security')
        ->assertJsonMissingPath('paths./api/v1/roles/contributor-institutions/ernie.get.security')
        ->assertJsonMissingPath('paths./api/v1/roles/authors/ernie.get.responses.401')
        ->assertJsonMissingPath('paths./api/v1/roles/contributor-persons/ernie.get.responses.401')
        ->assertJsonMissingPath('paths./api/v1/roles/contributor-institutions/ernie.get.responses.401')
