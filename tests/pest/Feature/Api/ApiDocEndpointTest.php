...
it('returns the OpenAPI documentation as JSON', function () {
    ...
    $response
        ...
        ->assertJsonPath('tags.5.name', 'Changelog')
        ->assertJsonPath('paths./api/changelog.get.tags.0', 'Changelog')
        ->assertJsonPath('paths./api/changelog.get.security', [])
        ...
        ->assertJsonPath('components.schemas.ChangelogRelease.properties.improvements.items.$ref', '#/components/schemas/ChangelogEntry')
        ->assertJsonPath('components.schemas.ChangelogRelease.properties.fixes.items.$ref', '#/components/schemas/ChangelogEntry')
        ->assertJsonPath('components.schemas.ChangelogEntry.properties.references.items.$ref', '#/components/schemas/ChangelogReference')
        ->assertJsonPath('components.schemas.ChangelogReference.properties.type.enum.1', 'pull_request')
        ->assertJsonPath('components.schemas.ChangelogReference.properties.url.pattern', '^https://github\\.com/[^/]+/[^/]+/(issues|pull)/[1-9][0-9]*$')
        ...
        ->assertJsonPath('paths./api/v1/relation-types.get.responses.200.content.application/json.schema.items.$ref', '#/components/schemas/RelationType')
        ->assertJsonPath('paths./api/v1/relation-types/ernie.get.responses.200.content.application/json.schema.items.$ref', '#/components/schemas/RelationType')
        ->assertJsonPath('paths./api/v1/relation-types/elmo.get.responses.200.content.application/json.schema.items.$ref', '#/components/schemas/RelationType')
        ->assertJsonPath('paths./api/v1/identifier-types.get.responses.200.content.application/json.schema.items.$ref', '#/components/schemas/IdentifierType')
        ->assertJsonPath('paths./api/v1/identifier-types/ernie.get.responses.200.content.application/json.schema.items.$ref', '#/components/schemas/IdentifierType')
        ->assertJsonPath('paths./api/v1/identifier-types/elmo.get.responses.200.content.application/json.schema.items.$ref', '#/components/schemas/IdentifierType')
        ->assertJsonPath('components.schemas.RelationType.properties.description.type.0', 'string')
        ->assertJsonPath('components.schemas.RelationType.properties.description.type.1', 'null')
        ->assertJsonPath('components.schemas.RelationType.required.3', 'description')
        ->assertJsonPath('components.schemas.IdentifierType.properties.description.type.0', 'string')
        ->assertJsonPath('components.schemas.IdentifierType.properties.description.type.1', 'null')
        ->assertJsonPath('components.schemas.IdentifierType.required.3', 'description')
        ->assertJsonPath('components.schemas.IdentifierType.required.4', 'patterns')
        ...
        // Authenticated IGSN import endpoints
        ->assertJsonPath('paths./igsns/import/datacenters.get.tags.0', 'IGSN Imports')
        ->assertJsonPath('paths./igsns/import/datacenters.get.security.0.LaravelSession', [])
        ->assertJsonPath('paths./igsns/import/datacenters.get.responses.200.content.application/json.schema.$ref', '#/components/schemas/LegacyIgsnDatacenterListResponse')
        ->assertJsonPath('paths./igsns/import/datacenters.get.responses.403.$ref', '#/components/responses/ForbiddenError')
        ->assertJsonPath('paths./igsns/import/datacenters.get.responses.503.content.application/json.schema.$ref', '#/components/schemas/MessageResponse')
        ->assertJsonPath('paths./igsns/import/start-datacenter.post.tags.0', 'IGSN Imports')
        ->assertJsonPath('paths./igsns/import/start-datacenter.post.security.0.LaravelSession', [])
        ->assertJsonPath('paths./igsns/import/start-datacenter.post.security.0.CsrfToken', [])
        ->assertJsonPath('paths./igsns/import/start-datacenter.post.requestBody.content.application/json.schema.$ref', '#/components/schemas/DatacenterIgsnImportRequest')
        ->assertJsonPath('paths./igsns/import/start-datacenter.post.responses.200.content.application/json.schema.$ref', '#/components/schemas/IgsnImportStartResponse')
        ->assertJsonPath('paths./igsns/import/start-datacenter.post.responses.403.$ref', '#/components/responses/ForbiddenError')
        ->assertJsonPath('paths./igsns/import/start-datacenter.post.responses.422.content.application/json.schema.$ref', '#/components/schemas/ValidationErrorResponse')
        ...
        // Authenticated Related Work citation label endpoint
        ->assertJsonPath('paths./api/v1/related-identifiers/citation-label.get.tags.0', 'DataCite')
        ->assertJsonPath('paths./api/v1/related-identifiers/citation-label.get.security.0.LaravelSession', [])
        ->assertJsonPath('paths./api/v1/related-identifiers/citation-label.get.parameters.0.name', 'identifier')
        ->assertJsonPath('paths./api/v1/related-identifiers/citation-label.get.parameters.0.required', true)
        ->assertJsonPath('paths./api/v1/related-identifiers/citation-label.get.parameters.0.schema.maxLength', 2183)
        ->assertJsonPath('paths./api/v1/related-identifiers/citation-label.get.parameters.1.name', 'identifierType')
        ->assertJsonPath('paths./api/v1/related-identifiers/citation-label.get.parameters.1.schema.enum.0', 'DOI')
        ->assertJsonPath('paths./api/v1/related-identifiers/citation-label.get.parameters.1.schema.enum.1', 'URL')
        ->assertJsonPath('paths./api/v1/related-identifiers/citation-label.get.responses.200.content.application/json.schema.$ref', '#/components/schemas/RelatedIdentifierCitationLabelResponse')
        ->assertJsonPath('paths./api/v1/related-identifiers/citation-label.get.responses.401.content.application/json.schema.$ref', '#/components/schemas/MessageResponse')
        ->assertJsonPath('paths./api/v1/related-identifiers/citation-label.get.responses.404.content.application/json.schema.$ref', '#/components/schemas/ErrorResponse')
        ->assertJsonPath('paths./api/v1/related-identifiers/citation-label.get.responses.422.content.application/json.schema.oneOf.0.$ref', '#/components/schemas/ValidationErrorResponse')
        ->assertJsonPath('paths./api/v1/related-identifiers/citation-label.get.responses.429.content.application/json.schema.$ref', '#/components/schemas/MessageResponse')
        ->assertJsonPath('components.schemas.RelatedIdentifierCitationLabelResponse.additionalProperties', false)
        ->assertJsonPath('components.schemas.RelatedIdentifierCitationLabelResponse.properties.identifier_type.enum.1', 'URL')
        ->assertJsonPath('components.schemas.ErrorResponse.required.0', 'error')
        // Public portal keyword suggestion, count, resource preview, and map endpoints
        ->assertJsonPath('paths./{portal}-search/free-keyword-suggestions.get.tags.0', 'Portal')
        ->assertJsonPath('paths./{portal}-search/free-keyword-suggestions.get.security', [])
        ->assertJsonPath('paths./{portal}-search/free-keyword-suggestions.get.parameters.0.name', 'portal')
        ->assertJsonPath('paths./{portal}-search/free-keyword-suggestions.get.parameters.0.schema.enum.0', 'doi')
        ->assertJsonPath('paths./{portal}-search/free-keyword-suggestions.get.parameters.1.name', 'q')
        ->assertJsonPath('paths./{portal}-search/free-keyword-suggestions.get.parameters.1.required', true)
        ->assertJsonPath('paths./{portal}-search/free-keyword-suggestions.get.parameters.1.schema.minLength', 2)
        ->assertJsonPath('paths./{portal}-search/free-keyword-suggestions.get.parameters.1.schema.maxLength', 100)
        ->assertJsonPath('paths./{portal}-search/free-keyword-suggestions.get.responses.200.content.application/json.schema.$ref', '#/components/schemas/PortalKeywordSuggestionResponse')
        ->assertJsonPath('paths./{portal}-search/free-keyword-suggestions.get.responses.422.content.application/json.schema.$ref', '#/components/schemas/ValidationErrorResponse')
        ->assertJsonPath('paths./{portal}-search/free-keyword-suggestions.get.responses.429.content.application/json.schema.$ref', '#/components/schemas/MessageResponse')
        ->assertJsonPath('components.schemas.PortalKeywordSuggestionResponse.properties.data.maxItems', 20)
        ->assertJsonPath('components.schemas.PortalKeywordSuggestionResponse.properties.data.items.$ref', '#/components/schemas/PortalKeywordSuggestion')
        ->assertJsonPath('components.schemas.PortalKeywordSuggestion.properties.scheme.type', 'null')
        ->assertJsonPath('components.schemas.PortalKeywordSuggestion.properties.count.minimum', 1)
        ->assertJsonPath('paths./{portal}-search/count.get.tags.0', 'Portal')
        ->assertJsonPath('paths./{portal}-search/count.get.security', [])
        ...
        ->assertJsonPath('paths./{portal}-search/resources/{resourceId}/preview.get.tags.0', 'Portal')
        ->assertJsonPath('paths./{portal}-search/resources/{resourceId}/preview.get.security', [])
        ->assertJsonPath('paths./{portal}-search/resources/{resourceId}/preview.get.parameters.0.name', 'portal')
        ->assertJsonPath('paths./{portal}-search/resources/{resourceId}/preview.get.parameters.1.name', 'resourceId')
        ->assertJsonPath('paths./{portal}-search/resources/{resourceId}/preview.get.parameters.1.schema.minimum', 1)
        ->assertJsonPath('paths./{portal}-search/resources/{resourceId}/preview.get.responses.200.content.application/json.schema.$ref', '#/components/schemas/PortalResourcePreviewResponse')
        ->assertJsonPath('paths./{portal}-search/resources/{resourceId}/preview.get.responses.404.content.application/json.schema.$ref', '#/components/schemas/MessageResponse')
        ->assertJsonPath('paths./{portal}-search/resources/{resourceId}/preview.get.responses.429.content.application/json.schema.$ref', '#/components/schemas/MessageResponse')
        ->assertJsonPath('paths./{portal}-search/resources/{resourceId}/preview.get.responses.503.content.application/json.schema.$ref', '#/components/schemas/MessageResponse')
        ->assertJsonPath('components.schemas.PortalResourcePreviewResponse.properties.citation.$ref', '#/components/schemas/PortalResourcePreviewCitation')
        ->assertJsonPath('components.schemas.PortalResourcePreviewResponse.properties.abstract.type.1', 'null')
        ->assertJsonPath('components.schemas.PortalResourcePreviewCitation.properties.styleId.enum.0', 'apa-7')
        ->assertJsonPath('components.schemas.PortalResourcePreviewCitation.properties.text.minLength', 1)
        ...
        ->assertJsonPath('components.schemas.LegacyIgsnDatacenter.properties.resource_count.minimum', 0)
        ->assertJsonPath('components.schemas.LegacyIgsnDatacenterListResponse.properties.datacenters.items.$ref', '#/components/schemas/LegacyIgsnDatacenter')
        // PID schemas
        ...
        ->assertJsonPath('components.schemas.MslLaboratoriesResponse.properties.total.minimum', 0)
        ->assertJsonPath('components.schemas.MslLaboratoriesResponse.properties.data.minItems', 0)
