...
it('returns the OpenAPI documentation as JSON', function () {
    ...
    $response
        ...
        // Public portal keyword suggestion, count, and map endpoints
        ->assertJsonPath('paths./search/free-keyword-suggestions.get.tags.0', 'Portal')
        ->assertJsonPath('paths./search/free-keyword-suggestions.get.security', [])
        ->assertJsonPath('paths./search/free-keyword-suggestions.get.parameters.0.name', 'q')
        ->assertJsonPath('paths./search/free-keyword-suggestions.get.parameters.0.required', true)
        ->assertJsonPath('paths./search/free-keyword-suggestions.get.parameters.0.schema.minLength', 2)
        ->assertJsonPath('paths./search/free-keyword-suggestions.get.parameters.0.schema.maxLength', 100)
        ->assertJsonPath('paths./search/free-keyword-suggestions.get.responses.200.content.application/json.schema.$ref', '#/components/schemas/PortalKeywordSuggestionResponse')
        ->assertJsonPath('paths./search/free-keyword-suggestions.get.responses.422.content.application/json.schema.$ref', '#/components/schemas/ValidationErrorResponse')
        ->assertJsonPath('paths./search/free-keyword-suggestions.get.responses.429.content.application/json.schema.$ref', '#/components/schemas/MessageResponse')
        ...
        ->assertJsonPath('paths./search/count.get.tags.0', 'Portal')
        ->assertJsonPath('paths./search/count.get.security', [])
        ->assertJsonPath('paths./search/count.get.parameters.0.name', 'q')
        ->assertJsonPath('paths./search/count.get.parameters.6.name', 'thesaurus_keywords[]')
        ->assertJsonPath('paths./search/count.get.parameters.13.name', 'year_to')
        ->assertJsonPath('paths./search/count.get.responses.200.content.application/json.schema.$ref', '#/components/schemas/PortalCountResponse')
        ->assertJsonPath('paths./search/count.get.responses.429.content.application/json.schema.$ref', '#/components/schemas/MessageResponse')
        ->assertJsonPath('paths./search/count.get.responses.500.content.application/json.schema.$ref', '#/components/schemas/MessageResponse')
        ...
        ->assertJsonPath('paths./search/map.get.tags.0', 'Portal')
        ->assertJsonPath('paths./search/map.get.security', [])
        ->assertJsonPath('paths./search/map.get.responses.200.content.application/json.schema.$ref', '#/components/schemas/PortalMapResponse')
        ->assertJsonPath('paths./search/map.get.responses.422.content.application/json.schema.$ref', '#/components/schemas/ValidationErrorResponse')
        ->assertJsonPath('paths./search/map.get.responses.429.content.application/json.schema.$ref', '#/components/schemas/MessageResponse')
        ->assertJsonPath('paths./search/map.get.responses.500.content.application/json.schema.$ref', '#/components/schemas/MessageResponse')
        ->assertJsonPath('paths./search/map.get.responses.503.content.application/json.schema.$ref', '#/components/schemas/MessageResponse')
    ...
    expect(collect(data_get($spec, 'paths./search/map.get.parameters'))->pluck('name')->all())
