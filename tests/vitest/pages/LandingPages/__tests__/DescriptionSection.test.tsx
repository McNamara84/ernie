...
describe('DescriptionSection', () => {
    it('renders abstract text', () => {
        const descriptions = [
            { id: 1, value: 'This is the abstract text.', description_type: 'Abstract' },
        ];
    ...
    it('returns null when no abstract exists', () => {
        const descriptions = [
            { id: 1, value: 'Some methods.', description_type: 'Methods' },
        ];
    ...
    it('matches abstract case-insensitively', () => {
        const descriptions = [
            { id: 1, value: 'Lowercase abstract.', description_type: 'abstract' },
        ];
        render(<DescriptionSection descriptions={descriptions} />);
