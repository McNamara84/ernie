...
describe('AbstractSection', () => {
    ...
    describe('subjects section - unified keywords', () => {
        ...
        it('renders keyword badges as links to the portal', () => {
            ...
            expect(link).toHaveAttribute('href', '/doi-search?free_keywords%5B%5D=Geophysics');
            expect(link).not.toHaveAttribute('target');
            expect(searchLink).toHaveAttribute('href', '/doi-search?free_keywords%5B%5D=Geophysics');
        });
        ...
        it('encodes special characters in keyword portal links', () => {
            ...
            expect(link).toHaveAttribute('href', '/doi-search?free_keywords%5B%5D=Rock+%26+Soil');
        });
        ...
        it('renders thesauri keyword badges as links to the portal', () => {
            ...
            expect(link).toHaveAttribute(
                'href',
                '/doi-search?thesaurus_keywords%5B%5D=https%3A%2F%2Fgcmd.earthdata.nasa.gov%2Fkms%2Fconcept%2Fscience-earth',
            );
            expect(link).not.toHaveAttribute('target');
        });
