// Local test credentials - these are seeded by PlaywrightTestSeeder
// For local Docker testing, these defaults work out of the box
...
// These MUST be provided via environment variables - no defaults to prevent accidental use
export const STAGE_TEST_USERNAME = process.env.STAGE_TEST_USERNAME;
export const STAGE_TEST_PASSWORD = process.env.STAGE_TEST_PASSWORD;
