...
return [
    ...
    'assessment' => [
        ...
        'concurrency' => (int) env('FUJI_ASSESSMENT_CONCURRENCY', 1),
        ...
        'item_timeout_seconds' => (int) env('FUJI_ASSESSMENT_ITEM_TIMEOUT', 330),
        'lease_seconds' => (int) env('FUJI_ASSESSMENT_LEASE_SECONDS', 390),
